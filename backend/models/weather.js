...
async function get() {
    ...
    try {
        ...
        let location = await axios.get('http://api.ipstack.com/'+ip+'?access_key=8773b56636e9c17e2e130a4329d4bf9c', {'crossDomain': true});
        ...
        currentLocation.region = location.data.region_code;
         ...
         let response = await axios.get('https://api.darksky.net/forecast/a8de0abe53bc4c62e5826978c6bf640f/'+currentLocation.latitude+','+currentLocation.longitude)


        currentLocation.humidity = response.data.currently.humidity;
        currentLocation.apparentTemperature = response.data.currently.apparentTemperature;
